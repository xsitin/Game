    ...
    public sealed class HpPotionControl : UserControl
    {
        ...
        public HpPotionControl(Player player)
        {
            ...
            buy.Click += (sender, args) =>
            {
                ...
                {
                    player.Gold -= 25;
                    player.Storage.Add(new ActiveItem("HP Potion",
                        new (Characteristics characteristic, int value)[] {(Characteristics.Health, 50)}));
        ...
        {
            e.Graphics.DrawImage(Resource.HPpotion, new Rectangle(0, 0, 100, 100));
        }
    }
}