...
namespace Game.Control
{
    public sealed class BasicHeroCardControl : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawImage(Resource.HeroCard, new Rectangle(0, 0, _size.Width, _size.Height));
            e.Graphics.DrawString(_hero.Name + $"[{_hero.Level}]", new Font(FontFamily.GenericSerif, 12), brush, 270,
                34);
            e.Graphics.DrawString(_hero.Specialization + "|" + _hero.Position, new Font(FontFamily.GenericSerif, 12),
                brush, 270, 64);
