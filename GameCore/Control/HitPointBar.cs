...
namespace GameCore.Control
{
    ...
    {
        private readonly List<BasicCreature> _heroes;
        ...
        {
            e.Graphics.FillRectangle(new SolidBrush(Color.Gray), new RectangleF(5, 5, 165, _heroes.Count * 55 - 5));
            e.Graphics.DrawRectangle(new Pen(Color.Black, 10), new Rectangle(0, 0, 170, _heroes.Count * 55));
            var dx = 0;
            var dy = 0;
