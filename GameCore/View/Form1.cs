    ...
    public sealed partial class Form1 : Form
    {
        ...
        public void ShowMenu()
        {
            ...
            var newGame = new Button
            {
                ...
                BackgroundImage = Resource.newGame,
            ...
            BackgroundImage = Resource.StartGameArt;
            BackgroundImageLayout = ImageLayout.Stretch;
            Table.BackColor = Color.Transparent;
        ...
        private void LoadScreen()
        {
            var panel = new Panel
            {
                ...
                BackgroundImage = Resource.Skroll,
                BackgroundImageLayout = ImageLayout.Stretch
            };
            ...
            foreach (var saveName in savesNames)
            {
                ...
                save.Click += (o, eventArgs) =>
                {
                    ...
                    File.SetLastAccessTime(
                        Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"\Game\" + saveName,
                        DateTime.Now);
                    Controls.Clear();
                    VillageControls();
                };
        ...
        private static List<string> GetSaveNames()
        {
            ...
            Array.Sort(files,
                (f, f2) => f2.LastAccessTime.CompareTo(f.LastAccessTime)
            );
            return files
        ...
        public void CreateNewGameScreen()
        {
            ...
            var warriorButton = new RadioButton
            {
                Bounds = new Rectangle(35, 0, 70, 50), Text = "Воин", Font = new Font(FontFamily.GenericSansSerif, 13)
            };
            var archerButton = new RadioButton
            {
                Bounds = new Rectangle(135, 0, 90, 50), Text = "Лучник",
                Font = new Font(FontFamily.GenericSansSerif, 13)
            };
            var wizardButton = new RadioButton
            {
                Bounds = new Rectangle(245, 0, 90, 50), Text = "Маг", Font = new Font(FontFamily.GenericSansSerif, 13)
            };
        ...
        {
            Controls.Clear();
            BackgroundImage = Resource.Village;
            ...
            {
                Controls.Clear();
                BackgroundImage = Resource.barrack;
                BackToVillage();
            ...
            goHunt.Click += (sender, args) =>
            {
                ...
                else
                {
                    ...
                    BackgroundImage = Resource.DarkForest;
            ...
            menuButton.BackgroundImage = Resource.upload;
        ...
        {
            Controls.Clear();
            var saveGame = new Button
            {
                Bounds = new Rectangle(20, 20, 360, 100), Font = new Font(FontFamily.GenericMonospace, 20),
